...
namespace finalblackbook {
    ...
    public partial class pharmacyDataSet7 : global::System.Data.DataSet {
        ...
        public partial class custDataTable : global::System.Data.TypedTableBase<custRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public custRow AddcustRow(int id, string name, string gen, string mob, string addr) {
        ...
        public partial class custRow : global::System.Data.DataRow {
            ...
            public string gen {
                get {
                    try {
                        return ((string)(this[this.tablecust.genColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'gen\' in table \'cust\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablecust.genColumn] = value;
                }
            }
            ...
            public bool IsgenNull() {
                return this.IsNull(this.tablecust.genColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetgenNull() {
                this[this.tablecust.genColumn] = global::System.Convert.DBNull;
            }
...
namespace finalblackbook.pharmacyDataSet7TableAdapters {
    ...
    public partial class custTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[cust] WHERE (([id] = @Original_id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_gen = 1 AND [gen] IS NULL) OR ([gen] = @Original_gen)) AND ((@IsNull_mob = 1 AND [mob] IS NULL) OR ([mob] = @Original_mob)) AND ((@IsNull_addr = 1 AND [addr] IS NULL) OR ([addr] = @Original_addr)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[cust] ([id], [name], [gen], [mob], [addr]) VALUES (@id, @name," +
                " @gen, @mob, @addr);\r\nSELECT id, name, gen, mob, addr FROM cust WHERE (id = @id)" +
                "";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[cust] SET [id] = @id, [name] = @name, [gen] = @gen, [mob] = @mob, [addr] = @addr WHERE (([id] = @Original_id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_gen = 1 AND [gen] IS NULL) OR ([gen] = @Original_gen)) AND ((@IsNull_mob = 1 AND [mob] IS NULL) OR ([mob] = @Original_mob)) AND ((@IsNull_addr = 1 AND [addr] IS NULL) OR ([addr] = @Original_addr)));
SELECT id, name, gen, mob, addr FROM cust WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, gen, mob, addr FROM dbo.cust";
        ...
        public virtual int Fill(pharmacyDataSet7.custDataTable dataTable) {
        ...
        public virtual pharmacyDataSet7.custDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            pharmacyDataSet7.custDataTable dataTable = new pharmacyDataSet7.custDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(pharmacyDataSet7.custDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(pharmacyDataSet7 dataSet) {
        ...
        public virtual int Delete(int Original_id, string Original_name, string Original_gen, string Original_mob, string Original_addr) {
        ...
        public virtual int Insert(int id, string name, string gen, string mob, string addr) {
        ...
        public virtual int Update(int id, string name, string gen, string mob, string addr, int Original_id, string Original_name, string Original_gen, string Original_mob, string Original_addr) {
            ...
            if ((Original_mob == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[11].Value = ((string)(Original_mob));
            }
            if ((Original_addr == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string gen, string mob, string addr, int Original_id, string Original_name, string Original_gen, string Original_mob, string Original_addr) {
            return this.Update(Original_id, name, gen, mob, addr, Original_id, Original_name, Original_gen, Original_mob, Original_addr);
        }
    }
